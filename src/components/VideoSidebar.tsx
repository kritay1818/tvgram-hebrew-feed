...
const VideoSidebar = () => {
  ...
  return (
    <aside className="fixed left-4 top-20 bottom-8 w-64 border-r bg-gradient-to-b from-[#1a2332] to-[#0f1419] text-white overflow-hidden flex flex-col rounded-r-lg">
      {/* Live Section */}
      {liveVideo && (
